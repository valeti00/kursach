    ...
    ui(new Ui::Stop4)
{
    ...
    Stop4::ui->pushButton->setStyleSheet(QString::fromUtf8("background-color: rgb(229, 200, 94);"
...
void Stop4::on_pushButton_clicked()
{
    emit nazad2(); // И вызываем сигнал на открытие третьего окна
