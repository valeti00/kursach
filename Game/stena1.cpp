    ...
    ui(new Ui::Razv)
{
    ...
    Razv::ui->pushButton->setStyleSheet(QString::fromUtf8("background-color: rgb(229, 200, 94);"
...
void Razv::on_pushButton_clicked()
{
    emit oknotri(); // И вызываем сигнал на открытие третьего окна
